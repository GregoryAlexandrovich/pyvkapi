...
MESSAGE = 'двухдневный мастер-класс свадебного фотографа Сергея Рожнова в СПб пройдет 1-2 апреля, приходи! 1й день - теория+обработка+пресеты и экшены, 2й - полноценная съемка для портфолио. Подробнее в группе https://vk.com/mkwedspb'
f = open('../4фотограф59.txt','r')
i=1
name=''
for line in f:
    print(line.strip())
